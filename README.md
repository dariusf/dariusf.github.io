...
- The `static` folder in your input directory will be copied to the output folder (via `addPassthroughCopy` in the `eleventy.config.js` file). This means `./static/css/*` will live at `./_build/css/*` after your build completes.
