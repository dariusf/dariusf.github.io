...
Generate a production-ready build to the `_build` folder:
...
- The `public` folder in your input directory will be copied to the output folder (via `addPassthroughCopy` in the `eleventy.config.js` file). This means `./public/css/*` will live at `./_build/css/*` after your build completes.
